...
var view_y = 480 * obj_ending_controller.SCALE_MULTIPLIER;  // Vertical start of the viewport
var view_w = 1280 * obj_ending_controller.SCALE_MULTIPLIER; // Width of the viewport
var view_h = 240 * obj_ending_controller.SCALE_MULTIPLIER; // Height of the viewport

// Border properties
var border_thickness = 4 * obj_ending_controller.SCALE_MULTIPLIER; // Thickness of the border
...
if (obj_ending_controller.ready_for_results_1) {
    ...
    if (obj_ending_controller.dressed) {
